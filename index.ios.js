...
var panResponderBasics = React.createClass({
  getInitialState: function() {
    return { open: false };
  },

  componentWillMount: function() {
    this.panRepsponder = PanResponder.create({
  ...
  render: function() {
    return (
      <View>
        ...
        <View ref="box" style={styles.viewStyle} {...this.panRepsponder.panHandlers}>
          <Text>Hi there</Text>
        </View>
      </View>
    );
...
AppRegistry.registerComponent('panResponderBasics', () => panResponderBasics);
